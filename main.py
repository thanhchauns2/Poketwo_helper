...
f = open("C:/Users/Laptop88_LTV/Documents/GitHub/Python/Bot/POKE-BOT-main/Missing.txt", "a")
...
async def on_message(message):
    ...
    if (message.content.startswith('!start') and message.channel.id == ID):
        while True:
            ...
            while not hint.startswith('The'):
                ...
                if hint.startswith("Congratulation"):
                    if 'color' in hint:
                        await channel.send('!gotem')
                    continue
                ...
                if embed['footer']['text'][:15] != 'Incense: Active':
                    await msg.delete()
                    continue
    ...
    if (message.content.startswith('!toggle') and message.channel.id == ID):
        client.bln = not client.bln
